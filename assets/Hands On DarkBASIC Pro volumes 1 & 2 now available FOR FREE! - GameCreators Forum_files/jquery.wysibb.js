...
WBBLANG['en'] = CURLANG = {
	...
	fs_xsmall: "Extra small",
	fs_small: "Small",
	fs_normal: "Normal",
	fs_large: "Large",
	fs_xlarge: "Extra Large",
...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,justifycenter,|,img,video,link,|,fontcolor,fontsize,|,quote,code",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				fontcolor: {
					...
					valueBBname: "color",
					subInsert: true,
					colors: "red,green,blue,orange,yellow,lime,skyblue,darkgreen",
					transform: {
				...
				fontsize: {
					...
					options: "fs_xsmall,fs_small,fs_normal,fs_large,fs_xlarge"
				},
				smilebox: {
					type: 'smilebox',
				...
				//select options
				fs_xsmall: {
					title: CURLANG.fs_xsmall,
					buttonText: "fs1",
					excmd: 'fontSize',
					exvalue: "xsmall",
					transform: {
						'<font class="fontsize xsmall">{SELTEXT}</font>':'[size=xsmall]{SELTEXT}[/size]'
					}
				},
				fs_small: {
					...
					exvalue: "small",
					transform: {
						'<font class="fontsize small">{SELTEXT}</font>':'[size=small]{SELTEXT}[/size]'
					}
				},
				fs_normal: {
				...
				fs_large: {
					title: CURLANG.fs_large,
					buttonText: "fs4",
					excmd: 'fontSize',
					exvalue: "large",
					transform: {
						'<font class="fontsize large">{SELTEXT}</font>':'[size=large]{SELTEXT}[/size]'
					}
				},
				fs_xlarge: {
					title: CURLANG.fs_xlarge,
					buttonText: "fs5",
					excmd: 'fontSize',
					exvalue: "xlarge",
					transform: {
						'<font class="fontsize xlarge">{SELTEXT}</font>':'[size=xlarge]{SELTEXT}[/size]'
					}
				},
