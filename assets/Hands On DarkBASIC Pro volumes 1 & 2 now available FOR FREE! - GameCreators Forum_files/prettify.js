  ...
  function prettyPrint(opt_whenDone) {
    ...
    function replaceWithPrettyPrintedHtml() {
      ...
      if (!isRawContent(cs)) {
        ...
        cs.innerHTML = '<pre style="padding:0px; margin:0px; border:none; background-color:#ffffff;line-height:inherit;font-family:inherit;font-size:inherit;color:inherit;">'+newContent+'</pre>';
      } else {
